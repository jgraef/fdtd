...
use crate::app::composer::scene::ui::{
    ComponentUi,
    ComponentWidget,
};
...
macro_rules! impl_register_component {
    ...
    (@begin($ty:ty, [$($params:tt)*])) => {
        impl $crate::app::composer::scene::components::RegisterComponent for $ty {
            #[allow(unused_variables)]
            fn register(builder: &mut $crate::app::composer::scene::components::RegisteredComponentBuilder) {
